      ...
      <div className="grid gap-6 lg:grid-cols-[260px_1fr]">
        ...
        <div className="rounded-3xl glass-strong p-6">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-5">
            <div className="grid h-24 w-24 place-items-center rounded-2xl bg-gradient-to-br from-[#F5E400] to-[#FF0A78] text-3xl font-bold text-black">AV</div>
            <div>
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            {[
              { l: "Full Name", v: "Arjun Verma" },
              { l: "Email", v: "arjun.verma@example.com" },
              { l: "Location", v: "Delhi, India" },
            ...
            <div className="md:col-span-2">
              ...
              <textarea rows={4} defaultValue="Passionate full-stack developer building delightful product experiences." className="mt-1 w-full rounded-xl bg-white/[0.04] px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-[#F5E400]/40" />
            </div>
          </div>
